...
{
    static let webBaseURLString = "http://fleetapp.info:3003/api"
    static let videoBaseURLString = "http://54.67.77.59:1935/vods3/wowzaserver/mp4:amazons3/teamfleetapp/"
